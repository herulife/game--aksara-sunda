  ...
  return (
    <main className="mockup-screen">
      ...
      <section className="relative z-10 mx-auto flex min-h-[calc(100vh-66px)] w-full max-w-[410px] flex-col items-center px-4 pb-5 pt-5 text-center sm:max-w-[450px] sm:px-5 sm:pb-6 sm:pt-6">
        ...
        <h1 className="mt-1 text-[3rem] font-black leading-[0.84] tracking-[0.02em] text-[#60431e] drop-shadow-[0_3px_0_rgba(255,255,255,0.22)] sm:text-[4rem]">
          SUNDA
          <br />
          GAME
        </h1>
        ...
        <div className="relative z-20 mt-4 grid w-full max-w-[320px] grid-cols-2 gap-3">
            <button
              ...
              className="pdf-panel-cream flex min-h-[58px] touch-manipulation items-center justify-center gap-2 rounded-[0.78rem] px-4 text-[0.98rem] font-black text-black shadow-[0_4px_0_rgba(152,130,67,0.26),0_12px_18px_rgba(35,28,15,0.12)] sm:min-h-[64px] sm:text-[1.02rem]"
            >
              <Image
        ...
        {showRegisterLink ? (
          <Link
            href="/register"
            className="relative z-20 mt-4 touch-manipulation text-sm font-bold text-[#fff8ec] underline underline-offset-4 drop-shadow-[0_3px_8px_rgba(46,38,18,0.22)]"
          >
            Daptar pamaen anyar
          </Link>
        ) : null}
